...
const manageUsers = [
  {
    name: "Managers",
    link: "/manage-users/managers"
  },
  {
    name: "Employees",
    link: "/manage-users/employees"
  },
  {
    name: "Customers",
...
const gallery = [
  {
    name: "Collections",
    link: "/gallery/subjects"
  },
  {
    name: "Public Images",
    link: "/gallery/public-images"
  }
]
...
// const NavbarDropdownLala = ({ title, children }) => (
//   <UncontrolledDropdown nav inNavbar className="border border-success">
//     <DropdownToggle nav>
//       <div className="position-relative">
...
const NavbarDropdownComponent = ({ title, children }) => (
  <UncontrolledDropdown nav inNavbar>
    ...
    <DropdownMenu style={{backgroundColor: '#f5f9fc'}}>
      <ListGroup>{children}</ListGroup>
    </DropdownMenu>
  </UncontrolledDropdown>
);

const NavbarDropdownItemLala = ({title, link}) => (
  <ListGroupItem>
    <Row noGutters className="align-items-center">
      <Col>
        <a href={link} className="text-dark" align="center" id={link} style={{textDecoration:'none'}}>
          <div>{title}</div>
        </a>
      </Col>
    </Row>
    ...
    <Navbar color="white" light expand>
      ...
      <Collapse navbar>
        <Nav className="ml-4" navbar>
          <ButtonGroup className='border rounded-lg shadow-sm' style={{backgroundColor: '#f5f9fc'}}>
            <div className='border-right'>
              <NavbarDropdownComponent title="Manage Users">
                {manageUsers.map((item, key) => {
                  return (
                    <NavbarDropdownItemLala
                      key={key}
                      title={item.name}
                      link={item.link}
                    />
            ...
            <div className='border-right'>
              <NavbarDropdownComponent title="Gallery">
            ...
            <div>
              <NavbarDropdownComponent title="Config">
                {config.map((item, key) => {
                  return (
                    <NavbarDropdownItemLala
                      key={key}
