...
import ContentModal from '../popup-us-managers/PopupAddNew';
    ...
    return (
      <div onScroll={this.handleScroll}>
        <div className={this.state.styleButton} style={{ width: '100%' }}>
          <Row>
            <Col>
            <h1 className='ml-6'><cite hidden={this.state.titleStatus} style={{textShadow: '2px 2px 8px #FF0000'}} title="Source Title">Managers</cite></h1>
            </Col>
            <Col xs="3">
