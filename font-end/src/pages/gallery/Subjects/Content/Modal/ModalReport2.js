...
import { Modal, ModalBody, ModalHeader, ModalFooter, Button, Input, ListGroup, Label } from 'reactstrap';

class ModalReport2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
        listReport: [
